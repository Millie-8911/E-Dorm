...
class NotifyService : Service() {
    ...
    override fun onCreate() {
        val notification = TkuNotification(this,"狀態追蹤","狀態追蹤",NotificationManager.IMPORTANCE_HIGH).apply {
        ...
        startForeground(19991218,notification)
    }
            ...
            listener = object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    if (machine["con"]=="usable"){
                        TkuNotification(this@NotifyService,"洗衣提醒","洗衣提醒").build("洗衣提醒","快去拿衣服啦(⁎⁍̴̛ᴗ⁍̴̛⁎)").show(
                            R.string.washReminder
                        )
                        stopListener()
                        stopSelf()
                    }
